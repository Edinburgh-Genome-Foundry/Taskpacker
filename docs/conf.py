# -*- coding: utf-8 -*-
#
# Plateo documentation build configuration file, created by
...
latex_documents = [
  ('index', 'Plateo.tex', u'Plateo Documentation',
   u'Zulko', 'manual'),
]
...
man_pages = [
    ('index', 'Plateo', u'PACKAGE_NAME Documentation',
     [u'Zulko'], 1)
]
...
texinfo_documents = [
  ('index', 'Plateo', u'Plateo Documentation',
   u'Zulko', 'Plateo', 'One line description of project.',
   'Miscellaneous'),
]
